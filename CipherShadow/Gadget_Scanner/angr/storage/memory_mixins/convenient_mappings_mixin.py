    ...
    def store(self, addr, data, size=None, **kwargs):
        if options.MEMORY_SYMBOLIC_BYTES_MAP in self.state.options:
            if data.symbolic:
                ...
                self._symbolic_addrs.difference_update(
        ...
        if not (
            ...
            # print("Yes addr is:", addr, "data is:", data)
