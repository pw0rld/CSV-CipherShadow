...
class SimState(PluginHub):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.reg_var_trace = dict()
        self.reg_value_trace = dict()
        self.pointer_trace = dict()
        self.imark_pointer_trace = list()
        self.imark_reg_var_trace = list()
        self.imark_var_trace = list()
        self.imark_addr = None
        self.trace_store = dict()
        self.var_trace = dict()
        self.value_trace = dict()
